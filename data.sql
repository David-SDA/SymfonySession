...
-- Listage des données de la table symfonysession.session : ~6 rows (environ)
INSERT INTO `session` (`id`, `libelle`, `nombre_places`, `date_debut`, `date_fin`, `formation_id`) VALUES
	...
	(9, 'test', 56, '2023-04-01 00:00:00', '2023-05-10 00:00:00', 2),
	(10, 'tt', 6, '2023-05-10 00:00:00', '2023-05-14 00:00:00', 2);

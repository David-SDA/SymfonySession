...
-- Listage de la structure de la table symfonysession. formateur
...
-- Listage des données de la table symfonysession.formateur : ~0 rows (environ)
...
INSERT INTO `session` (`id`, `libelle`, `nombre_places`, `date_debut`, `date_fin`, `formation_id`, `formateur_id`) VALUES
	(1, 'Strasbourg - DWWM1', 3, '2023-03-13 00:00:00', '2023-05-27 00:00:00', 1, 3),
	(2, 'Strasbourg - DWWM', 13, '2022-05-22 14:07:44', '2023-02-22 14:07:50', 1, 1),
	(3, 'Strasbourg - DWWM3', 16, '2024-01-22 14:08:33', '2024-09-22 14:08:41', 1, 3),
